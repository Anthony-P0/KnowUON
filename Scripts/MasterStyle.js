...
{/* 
                    ...
                    <ul className="social-links">
                        <li className="google">
                          <svg viewBox="0 0 18.005 18.005">
                            <g transform="translate(-40 -40)">
                              ...
                              <path d="M63.059,44.812l2.958,2.169a5.39,5.39,0,0,1,8.59-2.013l2.546-2.546a8.985,8.985,0,0,0-14.094,2.39Z" transform="translate(-22.021)" fill="#fff" />
                              <path d="M69.964,287.717A8.96,8.96,0,0,0,76,285.38l-2.786-2.358a5.387,5.387,0,0,1-8.328-2.483L61.949,282.8A9,9,0,0,0,69.964,287.717Z" transform="translate(-20.961 -229.712)" fill="#fff" />
                              <path d="M248.827,200.037H248.1V200H240v3.6h5.088a5.421,5.421,0,0,1-1.84,2.508h0l2.786,2.358A8.708,8.708,0,0,0,249,201.8,9.059,9.059,0,0,0,248.827,200.037Z" transform="translate(-190.998 -152.798)" fill="#fff" />
                            </g>
                          </svg>
                        </li>
                        ...
                        <li className="windows">
                          <svg viewBox="0 0 18.002 18.002">
                            <g transform="translate(-12.5 -12.523)">
                              <path d="M19.5,52.082h-7v6.037l7,.961Z" transform="translate(0 -30.063)" fill="#fff" />
                              <path d="M19.5,18.961l-7,.983v5.968h7Z" transform="translate(0 -4.892)" fill="#fff" />
                              <path d="M45.832,13.928v7.091h10v-8.5Z" transform="translate(-25.331)" fill="#fff" />
                              <path d="M45.832,52.082v7.135l10,1.372V52.082Z" transform="translate(-25.331 -30.063)" fill="#fff" />
                            </g>
                          </svg>
                        </li>
                      </ul> */}
